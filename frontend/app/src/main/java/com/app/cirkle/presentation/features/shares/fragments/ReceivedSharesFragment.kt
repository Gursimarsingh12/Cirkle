...
@AndroidEntryPoint
class ReceivedSharesFragment : BaseFragment<FragmentSharesListBinding>() {
        ...
        adapter = PagingSharedTweetsAdapter(
            ...
            onClick = object : PagingSharedTweetsAdapter.TweetItemClickListener {
                ...
                override fun onEditClick(tweet: Tweet) {
                    // Not supported in shared list for now
                }
    ...
    private fun observeShares() {
        lifecycleScope.launch {
            viewLifecycleOwner.lifecycle.repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.pagedReceivedShares.collectLatest { pagingData ->
